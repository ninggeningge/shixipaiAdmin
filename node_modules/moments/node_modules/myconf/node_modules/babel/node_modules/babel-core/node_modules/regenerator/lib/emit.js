...
Ep.contextProperty = function(name, computed) {
  return b.memberExpression(
    this.contextId,
    computed ? b.literal(name) : b.identifier(name), !!computed
  );
};
...
Ep.clearPendingException = function(tryLoc, assignee) {
  ...
  var catchCall = b.callExpression(
    this.contextProperty("catch", true), [tryLoc]
  );
...
Ep.getContextFunction = function(id) {
  return b.functionExpression(
    id || null /*Anonymous*/ , [this.contextId],
...
Ep.getDispatchLoop = function() {
  ...
  cases.push(
    b.switchCase(this.finalLoc, [
      // Internionally fall through to the "end" case...
    ]),
  ...
  switch (stmt.type) {
    ...
    case "ForInStatement":
      ...
      self.emitAssign(
        keyIterNextFn,
        b.callExpression(
          runtimeProperty("keys"), [self.explodeExpression(path.get("right"))]
        )
      );
      ...
      self.leapManager.withEntry(tryEntry, function() {
        ...
        if (finallyLoc) {
          ...
          self.emit(b.returnStatement(b.callExpression(
            self.contextProperty("finish"), [finallyEntry.firstLoc]
          )));
        }
      });
...
Ep.explodeExpression = function(path, ignoreResult) {
  ...
  function explodeViaTempVar(tempVar, childPath, ignoreChildResult) {
    ...
    assert.ok(!ignoreChildResult || !tempVar,
