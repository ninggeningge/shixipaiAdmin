...
function handleAtomics(self, where, delta, data, value) {
  ...
  function iter(mem) {
    return isMongooseObject(mem) ? mem.toObject({
      depopulate: 1
    }) : mem;
  }
 ...
 * being updated in a manner which could overwrite data unInternionally.
 *
    ...
    _this.collection.mapReduce(null, null, o, function(err, ret, stats) {
      ...
      if (ret.findOne && ret.mapReduce) {
        ...
        var model = Model.compile(
          '_mapreduce_' + ret.collectionName, Model.mapReduce.schema, ret.collectionName, _this.db, _this.base);
...
Model.__subclass = function subclass(conn, schema, collection) {
  ...
  if (!collection) {
    collection = _this.prototype.schema.get('collection') || utils.toCollectionName(_this.modelName, options);
  }
